...
public class DisplayRssFeedActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        calendar.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				// Essa op��o adiciona um evento no calend�rio sem mostrar o calendario para o usuario
				...
				// Essa op��o eh mais simples, porem faz com que o usuario tenha que confirmar a adi��o do evento no proprio calendario.
	...
	public EventoIme parse(String texto) {
		...
		{
			if(splitted[i].startsWith("T�tulo: ")) title = splitted[i].replace("T�tulo: ", "");
			...
			else if(splitted[i].startsWith("Descri��o: ")) description = splitted[i].replace("Descri��o: ", "");
